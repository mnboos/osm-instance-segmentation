...
class Ui_DlgPredict(object):
    def setupUi(self, DlgPredict):
        ...
        self.btnClose = QtGui.QPushButton(DlgPredict)
        ...
        QtCore.QObject.connect(self.btnClose, QtCore.SIGNAL(_fromUtf8("clicked()")), DlgPredict.reject)
    ...
    def retranslateUi(self, DlgPredict):
        ...
        self.btnClose.setText(_translate("DlgPredict", "Close", None))
