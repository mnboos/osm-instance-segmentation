...
class Ui_DlgPredict(object):
    ...
    def retranslateUi(self, DlgPredict):
        ...
        self.lblAddRawPredictions.setText(_translate("DlgPredict", "Add plain predictions"))
        self.chkAddPlainPredictions.setText(_translate("DlgPredict", "Add the unprocessed predictions from the neural network"))
