...
% s - if you need advanced listings, switch to minted!
...
\addto\extrasenglish{% English
    \renewcommand*{\figureautorefname}{Figure}             % fig:
    \renewcommand*{\tableautorefname}{Table}              % tab:
    \renewcommand*{\equationautorefname}{Equation}            % eq:
    \renewcommand*{\chapterautorefname}{Chapter}            % chp:
    \renewcommand*{\sectionautorefname}{Section}            % sec:
    \renewcommand*{\subsectionautorefname}{Section}         % subsec:
