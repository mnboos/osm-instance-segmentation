...
As a result of the inaccuracies in the predicted building masks, shown in \ref{fig:challenges:building_masks}, the contours of these predictions can not directly be used to create the vectorized outlines. Instead, the predictions have to be regularized. The approach used is derived from \cite{Partovi.2017} and described below.
